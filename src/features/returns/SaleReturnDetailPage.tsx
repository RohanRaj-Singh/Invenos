    ...
    return (
      <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto">
        <div className="flex flex-col items-center justify-center py-24 text-sm text-muted-foreground">
          ...
          <Link to="/sales/returns" className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg border border-border text-sm font-medium hover:bg-muted transition-colors">Back to Sale Returns</Link>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto space-y-5">
      ...
      <div className="flex items-center justify-between">
        <button onClick={() => navigate('/sales/returns')} className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div className="flex items-center gap-2">
          ...
          {originalSale && (
            <Link to={`/sales/${returnData.originalSaleId}`}
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {originalSale && (
            <div className="mt-1">
              <Link to={`/sales/${returnData.originalSaleId}`} className="text-xs text-primary hover:underline inline-flex items-center gap-1">
        ...
        <Card size="sm">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <Link
                to={`/sales/${returnData.originalSaleId}`}
